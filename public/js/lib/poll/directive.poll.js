	...
	constructor() {
		this.template = `<div class="container container-row container--space-between">
                <div class="container container-row container--content-to-end ui-relative">
                    <span class="ui-position--absolute ui-text--white font2 ui-text-shadow ui-text--uppercase" style="top:0px;">{{Poll.option1.displayName}}</span>
                    <span class="ui-position--absolute ui-text--white font--big ui-text-shadow ui-bring-to-top" style="bottom:0px;left:3px">{{Poll.option1.number}}</span>
